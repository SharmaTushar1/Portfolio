  ...
  return (
    <footer className="flex flex-col mt-auto mx-auto w-max-fit">
      <div className="flex w-max-fit mx-auto">
        ...
        <Link href="https://www.instagram.com/hindwantushar" target="_blank">
          <Image className="px-2" width={48} height={48} src="https://img.icons8.com/color/48/instagram.png" alt="Instagram"/>
        </Link>
        ...
        <Link href="https://www.twitter.com/SharmaTushar1" target="_blank">
